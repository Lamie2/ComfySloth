                    ...
                    <div className="col-6 col-sm-12 left">
                        ...
                        <form onSubmit={handleSubmit(onSubmit)}>
                            ...
                            <label className="forPassword">
                                <input type={visible ? "text" : "password"} placeholder="Password" {...register('password')}/><i className={visible ? "fa-solid fa-eye-slash" : "fa-solid fa-eye"}
                                    onClick={() => setVisible(!visible)}></i>
                            </label>
                            <label className="forPassword">
                                <input type={visible ? "text" : "password"} placeholder="Repeat Password" {...register('repeatPassword')} /><i className={visible ? "fa-solid fa-eye-slash" : "fa-solid fa-eye"}
                                    onClick={() => setVisible(!visible)}></i>
                            </label>
